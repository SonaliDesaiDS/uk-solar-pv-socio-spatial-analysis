...
The notebook reads from `../data/` relative to its own location (i.e. the `data/` folder at the repo root) and writes any generated artefacts to the notebook's working directory.
